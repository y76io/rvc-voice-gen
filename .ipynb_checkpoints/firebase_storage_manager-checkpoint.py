...
class CloudStorageManager:
    ...
    def upload_audio(
        ...
        try:
            ...
            blob_path = self._build_audio_path(
                client_id, project_id, character, language, filename
            )
    ...
    def upload_model(
        ...
        try:
            ...
            blob_path = self._build_model_path(
                client_id, project_id, character, model_version, filename
            )
            blob = self.bucket.blob(blob_path)
            blob.upload_from_filename(local_path)
            return blob_path
    ...
    def list_audio_files(
        self, client_id: str, project_id: str, character: str, language: str
    ) -> List[str]:
